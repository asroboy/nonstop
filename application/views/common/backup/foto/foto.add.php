        ...
        <div class="card-body pad">
          <form action="<?php echo base_url('common/'.$this->uri->segment(3).'/Add')?>" method="POST" enctype="multipart/form-data" id="frm_crud">
            <div class="form-group ">
              ...
              <input type="text" class="form-control" name="judul" placeholder="Nama foto..." required="">
            </div>
            <div class="form-group ">
              <label>File</label></br>
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <?php 
            $data = array('jumnya' => $this->File_M->All('foto')->num_rows());
          ...
          <table class="table table-hover table-bordered table-striped example1">
            ...
            <tbody>
              <?php
                ...
                $query = $this->File_M->Show('foto')->result_array();
