    ...
    <div class="col-12">
      ...
      <div class="card" style="display: none" id="form-add">
        <div class="card-body pad">
          <form action="<?php echo base_url('common/ChooseUs/Add')?>" method="POST" enctype="multipart/form-data" id="frm_crud">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <?php 
            $data = array('jumnya' => $this->ChooseUs_M->All()->num_rows());
          ...
          <table class="table table-hover table-bordered table-striped example1">
            ...
            <tbody>
              <?php
                ...
                $query = $this->ChooseUs_M->Show()->result_array();
              ...
              <tr>
                ...
                <td><img class="lazyload" data-src="<?php echo $this->Model_main->exists($show['file'], 'no.png')?>" style="width: 100px;"></td>
                ...
                <td>
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <a href="<?php echo base_url('common/ChooseUs/Delete/'.$show['id'])?>" class="btn btn-danger btn-sm" onclick="return confirm('Apa anda ingin menghapus data ( <?php echo $show['judul']?> ) ?')">Delete</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
