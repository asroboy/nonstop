    ...
    <div class="col-12">
      ...
      <div class="card"  id="form-add">
        <div class="card-body pad">
          <form action="<?php echo base_url('common/SubMenu/Update')?>" method="POST" enctype="multipart/form-data" id="frm_crud">
              ...
              <div class="col-md-4" style="margin-bottom: 10px;">
                ...
                <select name="id_menu" class="form-control" required="">
                  ...
                  <?php
                    ...
                    foreach ($menu as $s_main_menu) {
                      if ($show['id_menu'] == $s_main_menu['id']) {
                        $kondisi = 'selected';
                      }else{
                        $kondisi = ' ';
                      }
                      echo '<option value="'.$s_main_menu['id'].'" '.$kondisi.'>'.$s_main_menu['nama'].'</option>';
                    }
                  ?>
                </select>
              </div>
