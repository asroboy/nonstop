...
if(!empty($this->input->get('query'))){
  $url_baris1 = base_url("Panel/URI/".$this->uri->segment(3)."?query=".$this->input->get('query').'&seller='.$this->input->get('seller'));
  $url_baris2_1 = "?query=".$this->input->get('query').'&seller='.$this->input->get('seller');
}else{
