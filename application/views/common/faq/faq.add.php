        ...
        <div class="card-body pad">
          <form action="<?php echo base_url('common/'.$this->uri->segment(3).'/Add')?>" method="POST" enctype="multipart/form-data" id="frm_crud">
            <div class="form-group ">
              ...
              <input type="text" class="form-control" name="question" placeholder="Pertanyaan..." required="">
            </div>
            <div class="form-group ">
              <label>Jawaban</label>
              <textarea class="ckeditor" rows="3" name="answer" required="">Masukan Jawaban</textarea>
            </div>
            <div class="form-group">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <?php 
            $data = array('jumnya' => $this->Faq_M->All()->num_rows());
          ...
          <table class="table table-hover table-bordered table-striped example1">
            ...
            <tbody>
              <?php
                ...
                $query = $this->Faq_M->Show()->result_array();
                foreach ($query as $show) {
              ?>
              <tr>
                <td align="center"><?php echo $no++?></td>
                 <td>
                  <span style="font-weight: 600"><?php echo $show['question']?></span></br>
                  <?php echo $show['answer']?>
                  </br>
                  
                  Tampilkan : <?php echo $this->Model_main->show($show['tampilkan']);?></br>
                  Create By : <?php echo $this->Model_main->made($show['create_by'])?></br>
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <a href="<?php echo base_url('common/'.$this->uri->segment(3).'/Delete/'.$show['id'])?>" class="btn btn-danger btn-sm" onclick="return confirm('Apa anda ingin menghapus data ( <?php echo $show['question']?> ) ?')">Delete</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
