...
<?php
  if (empty($this->input->get('id'))) {
    include 'komplain.add.php'; 
  }else{
    if ($query->num_rows() > 0) {
      include 'komplain.detail.php'; 
    }else{
