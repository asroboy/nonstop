    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <?php 
            $data = array('jumnya' => $this->ServiceSubCategory_M->All()->num_rows());
          ...
          <table class="table table-hover table-bordered table-striped example1">
            ...
            <tbody>
              <?php
                ...
                $query = $this->ServiceSubCategory_M->Show()->result_array();
                foreach ($query as $show) {
              ?>
              <tr>
                <td align="center"><?php echo $no++?></td>
                <td><?php echo $show['title']?></td>
                <td><img class="lazyload" data-src="<?php echo call_folder($show['file'])?>"style="width: 150px;"></td>
                <td>
